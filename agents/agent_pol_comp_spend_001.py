...
It checks compliance wit policy POL-COMP-SPEND-001.
...
with MCPServerAdapter(server_params, connect_timeout=60) as mcp_tools:
    ...
    # Create task
    research_task = Task(
        description="Identify the top 10 compartments by consumption (amount) for the OCI tenant "
        "in the  weeks of the month of october 2025, analyze the trends and provide insights on usage patterns."
        "Analyze fully the top 10 compartments. Use only the amount, not the quantity.",
